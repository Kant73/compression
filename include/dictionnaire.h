...
/**
 * @brief Initialise le dictionnaire, m pour compression ou décompression
...
/**
 * @brief Insère un mot dans le dictionnaire. Génère le code associé et change la taille du code si nécessaire (ex: cpt = 511, taille_code = 9 -> taille_code = 10)
...
/**
 * @brief Ajoute un élément dans le tableau des codes (exclusif décompression)
 */
void ajouter_element(uint8_t i, type_dico* d);


/**
 * @brief  Recherche le code associé à un mot
...
/**
 * @brief  Recherche le mot associé à un code
...
/**
 * @brief Affiche le dictionnaire (récursif)
...
/**
 * @brief Permet de libérer un mot de la mémoire
...
/**
 * @brief Permet de libérer un dictionnaire (récursif)
...
/**
 * @brief Libérer le tableau (exclusif à la décompression)
 */
void liberer_tableau();


/**
 * @brief Ecrit dans le fichier les octets, mémorise les bits restants
...
/**
 * @brief Lit dans le fichier les octets, mémorise les bits restants
...
/**
 * @brief  Remonte le dictionnaire pour chercher le mot associé
...
/**
 * @brief Concatène un élément à un mot
...
/**
 * @brief  Permet de printf en binaire (%s)
...
/**
 * @brief Permet d'affecter au mot1 les valeurs du mot2
